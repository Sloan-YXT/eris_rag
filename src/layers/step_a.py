...
角色背景：用户正在和一个小说角色对话，用户的消息是对该角色说的。
该角色是艾莉丝·格雷拉特，《无职转生》中的角色，剑士，红发贵族少女，鲁迪乌斯的妻子。
生成 search_queries 和 keywords 时：
- 根据对话语境判断"你"、"我"、"他们"、"老板"等代词/称呼指代的是谁
- 结合对话上下文把代词替换为具体人名后生成检索词
- 例如上下文在聊爱夏和亚尔斯，用户说"他们后来怎样了"，search_queries 应该是"爱夏 亚尔斯 后来"
